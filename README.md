...
* Interactive Fitness Dashboard: Tracks active consistency streaks, daily caloric outcome estimates, and gives an instant preview of today's scheduled exercises.
...
* Integration: Built for seamless API configurations and modular scalability
...
1. Clone the repository: 
   ```
   git clone https://github.com/HN-Hassan-Nawaz/FlexoraFit.git
   cd FlexoraFit
   ```
